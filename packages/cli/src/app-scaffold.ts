...
export const generateAppScaffold = (
  ...
  Effect.gen(function* () {
    ...
    const files: Record<string, string> = {
      ...
      "ards/ARD-APP-001.ard.yaml": `id: ARD-APP-001\nkind: letter\nfamily: custom\nname: "Generated app stays valid"\ndescription: "Generated app code must compile after vocabulary generation"\nspirit:\n  - ARD-APP-000\nseverity: error\nchecks:\n  - description: "Generated app compiles from current vocabulary"\n    command: "pnpm generate && pnpm exec tsc --noEmit"\n`,
    }
