...
| `rta-prod-09-observability-telemetry` | local | Observability and telemetry | Direct CLI/dashboard demo: `rta check --trace-context`, derived operation event contracts, telemetry coverage, and watch mode correlate with provenance |
